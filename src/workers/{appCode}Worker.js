 ...
 * Example cron: */5 * * * * node /path/to/{appCode}Worker.js
 */
...
const {appCode}Service = require('../services/{appCode}Service');  // Adjust path accordingly

/**
 * Main worker function
 */
async function runWorker() {
  console.log(`[${new Date().toISOString()}] Starting {app-code} worker...`);
